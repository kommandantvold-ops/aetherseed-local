...
from logic.token_budget import sanitize_model_output, cut_at_scaffold_marker
...
class HorizonCompanion:
    ...
    def respond(self, user_text: str) -> str:
        ...
        response, _cut = cut_at_scaffold_marker(response)
        if _cut:
            print("[sanitize] cut at a scaffold marker the model emitted")
